...
/**
 ...
 server bind success
 server bind success 0
 client connect success 0
 client send event used 1018ms
 client connect success 0
 Hello World Client done20000used1988
 client send event used 972ms
 run program 10 success
 Program ended with exit code: 0
 */

int zero_mq_test_main(int argc, const char * argv[]) {
    ...
    auto clientFunc = [] {
        ...
        int connect = zmq_connect (requester, "tcp://localhost:5555");
