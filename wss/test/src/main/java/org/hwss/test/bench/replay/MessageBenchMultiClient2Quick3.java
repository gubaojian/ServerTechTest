 ...
 *
 *
 * start new turn total message 4000005
 * receive used 24100.6ms
 *
 * */
public class MessageBenchMultiClient2Quick3 extends WebSocketClient {
    ...
    public MessageBenchMultiClient2Quick3(URI serverUri) {
        super(serverUri);
    }
    ...
    public static void main(String[] args) throws Exception {
       ...
       System.out.println(msg);
        ...
        WebSocketClient mainClient = new MessageBenchMultiClient2Quick3(new URI("wss://localhost:9001/wss?app_id=434&group=client"));
        ...
        Runnable runnable = new Runnable() {
            ...
            public void run() {
                // Create all-trusting host name verifier
                 try {
                     WebSocketClient client = new MessageBenchMultiClient2Quick3(new URI("wss://localhost:9001/wss?app_id=434&group=client"));
                     client.setConnectionLostTimeout(180);
                     client.connectBlocking();
                     for(int i=0; i < 10000*200; i++) {
                         ClientFastTextFrame frame  = new ClientFastTextFrame();
                         frame.setPayload(ByteBuffer.wrap(Charsetfunctions.utf8Bytes(msg)));
