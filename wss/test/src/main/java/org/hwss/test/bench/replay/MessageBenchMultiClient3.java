 ...
 *  512 bytes 数据：
 *
 *  start new turn total message 7987924
 * receive used 40077.7ms
 * start new turn total message 7998605
 * receive used 40177.5ms
 * start new turn total message 8000004
 * receive used 40214.9ms
 * start new turn total message 8000005
 * receive used 40215.1ms
 *
 * 每秒：20万
 *
 * send message end 40220
 *
 * 数据小了速度快，说明瓶颈点在网卡。
 *
 * */
public class MessageBenchMultiClient3 extends WebSocketClient {
    ...
    public MessageBenchMultiClient3(URI serverUri) {
        super(serverUri);
    }
    ...
    public static void main(String[] args) throws Exception {
       ...
       System.out.println(msg);
        ...
        WebSocketClient mainClient = new MessageBenchMultiClient3(new URI("wss://localhost:9001/wss?app_id=434&group=client"));
        ...
        Runnable runnable = new Runnable() {
            ...
            public void run() {
                // Create all-trusting host name verifier
                 try {
                     WebSocketClient client = new MessageBenchMultiClient3(new URI("wss://localhost:9001/wss?app_id=434&group=client"));
