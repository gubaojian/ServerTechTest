 ...
 *
 * start new turn total message 21888265
 * receive used 13048ms
 *
 * server单线程。
 * 11个client线程：180万每秒
 *
 ...
 *  *
 * */
public class MessageBenchMultiMorePlainSmallClient extends WebSocketClient {

    private List<String> messages = new ArrayList<>();
    private  long startTime = 0;


    public MessageBenchMultiMorePlainSmallClient(URI serverUri) {
        super(serverUri);
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        WebSocketClient mainClient = new MessageBenchMultiMorePlainSmallClient(new URI("ws://localhost:9002/wss?app_id=434&group=client"));
        ...
        Runnable runnable = new Runnable() {
            ...
            public void run() {
                // Create all-trusting host name verifier
                 try {
                     WebSocketClient client = new MessageBenchMultiMorePlainSmallClient(new URI("ws://localhost:9002/wss?app_id=434&group=client"));
