package org.hwss.test.bench.binary;
...
public class MessageBenchClient extends WebSocketClient2 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        MessageBenchClient client = new MessageBenchClient(new URI("wss://localhost:9001/wss?app_id=434&group=client"));
        ...
        WebSocketClient2.start = System.currentTimeMillis();
        byte[] bts = RandomUtils.nextBytes(64);
