 ...
 *
 * */
public class MessageBenchClient2Quick extends WebSocketClient {

    private List<String> messages = new ArrayList<>();
    private  long startTime = 0;


    public MessageBenchClient2Quick(URI serverUri) {
        super(serverUri);
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        byte[] bts = RandomUtils.nextBytes(10024);
        ...
        WebSocketClient client = new MessageBenchClient2Quick(new URI("wss://localhost:9001/wss?app_id=434&group=client"));
