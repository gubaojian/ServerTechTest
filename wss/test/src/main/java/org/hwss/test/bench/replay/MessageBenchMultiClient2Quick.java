 ...
 *
 * */
public class MessageBenchMultiClient2Quick extends WebSocketClient {
    ...
    public MessageBenchMultiClient2Quick(URI serverUri) {
        super(serverUri);
    }
    ...
    public static void main(String[] args) throws Exception {
       ...
       System.out.println(msg);
        ...
        WebSocketClient mainClient = new MessageBenchMultiClient2Quick(new URI("wss://localhost:9001/wss?app_id=434&group=client"));
        ...
        Runnable runnable = new Runnable() {
            ...
            public void run() {
                // Create all-trusting host name verifier
                 try {
                     WebSocketClient client = new MessageBenchMultiClient2Quick(new URI("wss://localhost:9001/wss?app_id=434&group=client"));
