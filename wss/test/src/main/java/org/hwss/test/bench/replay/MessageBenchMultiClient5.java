 ...
 *  128 bytes 数据：
 *
 *  start new turn total message 7720814
 * receive used 17137.5ms
 * start new turn total message 7760408
 * receive used 17207ms
 * start new turn total message 7773586
 * receive used 17226.6ms
 * start new turn total message 8000005
 * receive used 18133.1ms
 *
 * send message end 16976
 *
 * start new turn total message 7742872
 * receive used 17453.3ms
 * start new turn total message 7937918
 * receive used 17817ms
 * start new turn total message 7945099
 * receive used 17830.4ms
 * start new turn total message 8000005
 * receive used 18047.9ms
 *
 * send message end 17832
 *
 * 每秒：40-45万
 *
 * */
public class MessageBenchMultiClient5 extends WebSocketClient {
    ...
    public MessageBenchMultiClient5(URI serverUri) {
        super(serverUri);
    }
    ...
    public static void main(String[] args) throws Exception {
        byte[] bts = RandomUtils.nextBytes(128);
       ...
       System.out.println(msg);
        ...
        WebSocketClient mainClient = new MessageBenchMultiClient5(new URI("wss://localhost:9001/wss?app_id=434&group=client"));
        ...
        Runnable runnable = new Runnable() {
            ...
            public void run() {
                // Create all-trusting host name verifier
                 try {
                     WebSocketClient client = new MessageBenchMultiClient5(new URI("wss://localhost:9001/wss?app_id=434&group=client"));
