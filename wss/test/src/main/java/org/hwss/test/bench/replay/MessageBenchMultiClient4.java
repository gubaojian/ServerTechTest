 ...
 *  256 bytes 数据：
 *
 *  start new turn total message 7982994
 * receive used 24397.6ms
 * start new turn total message 7996934
 * receive used 24492.9ms
 * start new turn total message 8000004
 * receive used 24516ms
 * start new turn total message 8000005
 * receive used 24516.3ms
 * send message end 24523
 *
 * start new turn total message 7832769
 * receive used 24677.3ms
 * start new turn total message 7872680
 * receive used 24768.2ms
 * start new turn total message 7940821
 * receive used 24905.2ms
 * start new turn total message 8000005
 * receive used 25116ms
 *
 * send message end 24746
 *
 *
 * 每秒：32万
 *
 *
 * */
public class MessageBenchMultiClient4 extends WebSocketClient {
    ...
    public MessageBenchMultiClient4(URI serverUri) {
        super(serverUri);
    }
    ...
    public static void main(String[] args) throws Exception {
        byte[] bts = RandomUtils.nextBytes(256);
       ...
       System.out.println(msg);
        ...
        WebSocketClient mainClient = new MessageBenchMultiClient4(new URI("wss://localhost:9001/wss?app_id=434&group=client"));
        ...
        Runnable runnable = new Runnable() {
            ...
            public void run() {
                // Create all-trusting host name verifier
                 try {
                     WebSocketClient client = new MessageBenchMultiClient4(new URI("wss://localhost:9001/wss?app_id=434&group=client"));
