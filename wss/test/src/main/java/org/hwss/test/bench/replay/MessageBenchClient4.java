 ...
 * json
 *start new turn total message 2000002
 * receive used 11350.4ms
 *
 * start new turn total message 2000002
 * receive used 10994.7ms
 *
 * send message end 10997

 * 每秒19-20万  176mb每秒
 *
 * */
public class MessageBenchClient4 extends WebSocketClient {

    private List<String> messages = new ArrayList<>();
    private  long startTime = 0;


    public MessageBenchClient4(URI serverUri) {
        super(serverUri);
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        msgObj.put("time", UUID.randomUUID().toString());
        msgObj.put("content", "测试说话，我说的很好听");
        msgObj.put("name", "测试说话，我说的很好听");
        ...
        WebSocketClient client = new MessageBenchClient4(new URI("wss://localhost:9001/wss?app_id=434&group=client"));
