 ...
 *
 * */
public class MessageBenchiAdmin2 extends WebSocketClient {

    private static HashSet<String> messages = new HashSet<>();
    private static long startTime = 0;

    public MessageBenchiAdmin2(URI serverUri) {
        super(serverUri);
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        WebSocketClient client = new MessageBenchiAdmin2(new URI("wss://127.0.0.1:9001/wss/?app_id=434&group=admin"));
        client.connect();
    }
}
