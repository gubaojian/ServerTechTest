...
/***
 * 21个客户端：
 *start new turn total message 41691665
 * receive used 25743ms
 *
 *
 * 21个client线程：163万每秒
 *
 ...
 *
 * */
public class MessageBenchMultiMore20PlainSmallClient extends WebSocketClient {

    private List<String> messages = new ArrayList<>();
    private  long startTime = 0;


    public MessageBenchMultiMore20PlainSmallClient(URI serverUri) {
        super(serverUri);
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        WebSocketClient mainClient = new MessageBenchMultiMore20PlainSmallClient(new URI("ws://localhost:9002/wss?app_id=434&group=client"));
        ...
        Runnable runnable = new Runnable() {
            ...
            public void run() {
                // Create all-trusting host name verifier
                 try {
                     WebSocketClient client = new MessageBenchMultiMore20PlainSmallClient(new URI("ws://localhost:9002/wss?app_id=434&group=client"));
