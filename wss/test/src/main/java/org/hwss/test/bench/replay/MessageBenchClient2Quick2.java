 ...
 *
 * */
public class MessageBenchClient2Quick2 extends WebSocketClient2 {

    private List<String> messages = new ArrayList<>();
    private  long startTime = 0;


    public MessageBenchClient2Quick2(URI serverUri) {
        super(serverUri);
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        byte[] bts = RandomUtils.nextBytes(2048);
        ...
        WebSocketClient2 client = new MessageBenchClient2Quick2(new URI("wss://localhost:9001/wss?app_id=434&group=client"));
