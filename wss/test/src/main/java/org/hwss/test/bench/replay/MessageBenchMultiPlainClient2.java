 ...
 *
 * json :
 * start new turn total message 7999999
 * receive used 39560.1ms
 *
 * start new turn total message 8000001
 * receive used 38513.4ms
 *
 * start new turn total message 8000001
 * receive used 38978.7ms
 *
 * send message end 38983
 *
 * 4个线程： 20万每秒， 600mb每秒
 *
 * */
public class MessageBenchMultiPlainClient2 extends WebSocketClient {

    private List<String> messages = new ArrayList<>();
    private  long startTime = 0;


    public MessageBenchMultiPlainClient2(URI serverUri) {
        super(serverUri);
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        WebSocketClient mainClient = new MessageBenchMultiPlainClient2(new URI("ws://localhost:9002/wss?app_id=434&group=client"));
        ...
        Runnable runnable = new Runnable() {
            ...
            public void run() {
                // Create all-trusting host name verifier
                 try {
                     WebSocketClient client = new MessageBenchMultiPlainClient2(new URI("ws://localhost:9002/wss?app_id=434&group=client"));
