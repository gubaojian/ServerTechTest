 ...
 *
 * */
public class MessageBenchClient2 extends WebSocketClient {

    private List<String> messages = new ArrayList<>();
    private  long startTime = 0;


    public MessageBenchClient2(URI serverUri) {
        super(serverUri);
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        WebSocketClient client = new MessageBenchClient2(new URI("wss://localhost:9001/wss?app_id=434&group=client"));
