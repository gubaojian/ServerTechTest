...
public class MessageBenchMultiClient extends WebSocketClient {
    ...
    public static void main(String[] args) throws Exception {
        ...
        WebSocketClient mainClient = new MessageBenchMultiClient(new URI("ws://localhost:9001/wss?app_id=434&group=client"));
        ...
        Runnable runnable = new Runnable() {
            ...
            public void run() {
                // Create all-trusting host name verifier
                 try {
                     WebSocketClient client = new MessageBenchMultiClient(new URI("ws://localhost:9001/wss?app_id=434&group=client"));
