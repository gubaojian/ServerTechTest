...
class DiscoverPageInnerNormal extends StatefulWidget {
  const DiscoverPageInnerNormal({super.key});

  @override
  State<StatefulWidget> createState() {
    return DiscoverPageInnerNormalState();
  }
}

class DiscoverPageInnerNormalState extends State<DiscoverPageInnerNormal> {
