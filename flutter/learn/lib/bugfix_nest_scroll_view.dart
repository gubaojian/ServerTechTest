...
class NestedScrollView extends StatefulWidget {
  ...
  const NestedScrollView(
      ...
      this.restorationId,
      this.scrollBehavior,
      this.forceRestoreScrollOffset = false});
  ...
  ///     }
  ///     }
  final bool forceRestoreScrollOffset;
...
class NestedScrollViewState extends State<NestedScrollView> {
  ...
  void initState() {
    ...
    _coordinator = _NestedScrollCoordinator(
        ...
        widget.forceRestoreScrollOffset);
  }
...
class _NestedScrollPosition extends ScrollPosition
  ...
  @override
  void restoreScrollOffset() {
    if (coordinator.canScrollBody || coordinator.forceRestoreScrollOffset) {
      super.restoreScrollOffset();
    }
  }
