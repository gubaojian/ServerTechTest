    ...
    public static void main(String[] args) throws Exception {
        {
            ...
            {
                RSA2Encryptor encryptor = new RSA2Encryptor();
                String sign = encryptor.sign(plainText, "UTF-8", privateKey);
                System.out.println(sign);
                System.out.println(encryptor.verify(plainText, "UTF-8", publicKey, sign));
            }
