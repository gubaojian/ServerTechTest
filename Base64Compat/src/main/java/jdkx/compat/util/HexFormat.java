...
public final class HexFormat {
    ...
    public String formatHex(byte[] bytes, int fromIndex, int toIndex) {
        ...
        Compat.Objects.checkFromToIndex(fromIndex, toIndex, bytes.length);
     ...
     * @throws IllegalArgumentException if an I/O exception occurs appending to the output
     */
    ...
    public byte[] parseHex(CharSequence string, int fromIndex, int toIndex) {
        ...
        Compat.Objects.checkFromToIndex(fromIndex, toIndex, string.length());
    ...
    public byte[] parseHex(char[] chars, int fromIndex, int toIndex) {
        ...
        Compat.Objects.checkFromToIndex(fromIndex, toIndex, chars.length);
    ...
    public int hashCode() {
        ...
        result = 31 * result + Compat.Boolean.hashCode(Arrays.equals(digits, UPPERCASE_DIGITS));
        return result;
    }
